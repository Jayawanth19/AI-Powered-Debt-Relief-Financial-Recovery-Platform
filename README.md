...
Demo Video: https://drive.google.com/drive/folders/1yHz4EaH_v0JtSNqe_K9_L0FuYkeucRyi?usp=sharing
...
```bash
cd AI-Debt-Relief-Platform/backend
python -m venv venv
...
```bash
cd AI-Debt-Relief-Platform/frontend
npm install
